...
totals). No token, no auth, no GraphQL, no third-party API -- just the public
HTML GitHub already serves to anonymous visitors.
"""
import datetime
import json
import os
...
USERNAME = os.environ.get("GH_PROFILE_USER", "arshhimself")
